...
namespace Pck
{
	public class LexAttribute : LexNode, IEquatable<LexAttribute>, ICloneable
	{
		public LexAttribute(string name, object value)
		{
			Name = name;
			Value = value;
		}
		...
		public LexAttribute Clone()
		{
			return new LexAttribute(Name, Value);
		}
		...
		public bool Equals(LexAttribute rhs)
		{
		...
		public static bool operator ==(LexAttribute lhs, LexAttribute rhs)
		{
